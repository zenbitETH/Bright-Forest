    ...
    <div className="App overflow-auto">
      ...
      <section className="my-20 ">
        ...
        <div className="text-xl xl:text-3xl">
          A dapp to gamify urban mobility with bicycle rides
        </div>
      ...
      <div class="text-9xl py-96 mx-10 text-white font-black animate-pulse">
        {" "}
        🕹️Demo time!
      </div>
      ...
      <div class="grid xl:grid-cols-3 gap-5 mt-20 text-white text-2xl font-exo mb-96">
        <div class="Future cursor-default">
          ...
          <div class="xl:text-9xl py-20 ">🗺️</div>
        </div>
        <div class="Future cursor-default">
          2. Multiplayer trips
          <div class="xl:text-9xl py-20 ">🚴‍♂️🚴‍♀️</div>
        </div>
        <div class="Future cursor-default">
          3. Deco implementation
          <div class="xl:text-9xl py-20 ">🏪</div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-3 gap-5 my-10 text-white text-2xl font-exo justify-items-center">
        <a href="https://github.com/HabacucMX">
          <div class="teamMB">
            <img
              src="https://avatars.githubusercontent.com/u/57845110?s=400&u=5460231e3addfd30b2f4f35650c81206e3d7552f&v=4"
              class="teamIMG"
            />
            habacuc.eth
            <div class="text-lg text-rider-500">UX/UI & Product design</div>
          </div>
        </a>
        <a href="https://github.com/shyam-patel-kira">
          <div class="teamMB">
            <img
              src="https://avatars.githubusercontent.com/u/57172347?v=4"
              class="teamIMG"
            />
            Shyam Patel
            <div class="text-lg text-rider-500">ZKsnarks & Smart contracts</div>
          </div>
        </a>
        <a href="https://github.com/Trillaboi">
          <div class="teamMB">
            <img
              src="https://avatars.githubusercontent.com/u/10591684?v=4"
              class="teamIMG"
            />
            Chisom Ikejiani
            <div class="text-lg text-rider-500">Fullstack dev</div>
          </div>
        </a>
      </div>
      <div class="text-9xl py-96 mx-10 text-white font-black animate-pulse">
