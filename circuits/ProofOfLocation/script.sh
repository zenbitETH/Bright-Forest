...
circom ProofOfLocation.circom --r1cs --wasm --sym --c
...
node generate_witness.js ProofOfLocation.wasm ../input.json witness.wtns
...
snarkjs groth16 setup ProofOfLocation.r1cs pot12_final.ptau ProofOfLocation_0000.zkey

echo "-------Making the contribution tau ceremony Phase-2-----\n\n"
snarkjs zkey contribute ProofOfLocation_0000.zkey ProofOfLocation_0001.zkey --name="1st Contributor Name" -v -e="kira"
snarkjs zkey export verificationkey ProofOfLocation_0001.zkey verification_key.json

cp ProofOfLocation_js/witness.wtns .
...
snarkjs groth16 prove ProofOfLocation_0001.zkey witness.wtns proof.json public.json
...
snarkjs zkey export solidityverifier ProofOfLocation_0001.zkey verifier.sol
